...
@NoArgsConstructor
@AllArgsConstructor
public class InterfaceLoadingCreateDTO {
    ...
    private InterfaceLoading.Source source = InterfaceLoading.Source.FILE;
    
    private String exclusDerniereLigne = "N";
    ...
    private List<InterfaceLoadingChampCreateDTO> champs;
}
