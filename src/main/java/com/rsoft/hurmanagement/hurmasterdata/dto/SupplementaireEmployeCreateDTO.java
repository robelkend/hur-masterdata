...
@NoArgsConstructor
@AllArgsConstructor
public class SupplementaireEmployeCreateDTO {
    ...
    private String typeSupplementaire; // HEURE, FERIE, NUIT, WEEKEND, OFF, CONGE, AUTRE
    ...
    private String baseCalcul; // SALAIRE_BASE, TAUX_HORAIRE, FIXE
    ...
    private String statut = "BROUILLON"; // BROUILLON, VALIDE
