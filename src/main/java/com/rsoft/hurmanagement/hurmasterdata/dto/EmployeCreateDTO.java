...
public class EmployeCreateDTO {
    ...
    @NotBlank(message = "Code employé is required")
    @Size(max = 50, message = "Code employé must not exceed 50 characters")
    private String codeEmploye; // Will be generated if param exists, otherwise required
