...
BEGIN
    IF EXISTS (
        ...
        WHERE table_name = 'type_employe'
          AND column_name = 'ajouter_bonus_apres'
    ) THEN
...
UPDATE type_employe
SET ajouter_bonus_apres_nb_minute_presence = NULL
WHERE ajouter_bonus_apres_nb_minute_presence IN ('Y', 'N');
